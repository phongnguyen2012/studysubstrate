...
pub mod give_me {
    ...
    impl GiveMe {
        ...
        // }
        // //#[ink(message)]
        // pub fn set_sender(&self, sender: AccountId) {
        //     ink_env::test::set_caller::<ink_env::DefaultEnvironment>(sender);
        // }
    
        // pub fn default_accounts(
        // ) -> ink_env::test::DefaultAccounts<ink_env::DefaultEnvironment> {
        //     ink_env::test::default_accounts::<ink_env::DefaultEnvironment>()
        // }
        // //#[ink(message)]
        // pub fn create_contract(&self, initial_balance: Balance) -> GiveMe {
    ...
    mod tests {
        ...
        fn test_transferred_value_must_fail() {
            ...
            // will see as transferred to it.
            set_sender(accounts.eve);
            ink_env::test::set_value_transferred::<ink_env::DefaultEnvironment>(15);
        ...
        pub fn create_contract(initial_balance: Balance) -> GiveMe {
            let accounts = default_accounts();
            set_sender(accounts.alice);
            set_balance(contract_id(), initial_balance);
            GiveMe::new()
        ...
        pub fn get_balance(account_id: AccountId) -> Balance {
            ink_env::test::get_account_balance::<ink_env::DefaultEnvironment>(account_id)
                .expect("Cannot get account balance")
        }
    }
